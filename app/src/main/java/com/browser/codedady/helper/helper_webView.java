...
import com.browser.codedady.databases.DbAdapter_History;
import com.browser.codedady.utils.Utils_AdBlocker;
import com.browser.codedady.utils.Utils_UserAgent;
...
public class helper_webView {
    ...
    public static void openURL (Activity activity, WebView mWebView, String text) {
