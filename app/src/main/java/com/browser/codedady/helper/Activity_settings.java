...
import com.browser.codedady.about.About_activity;
...
public class Activity_settings extends AppCompatActivity {
    ...
    public void onResume(){
        ...
        String URL = sharedPref.getString("openURL","");
    ...
    private void updateSettings () {
        ...
        if (sharedPref.getBoolean ("java", true)){
        ...
        if (sharedPref.getBoolean ("pictures", true)){
        ...
        String URL = sharedPref.getString("openURL","https://codedady.com");
