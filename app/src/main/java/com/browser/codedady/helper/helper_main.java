...
package com.browser.codedady.helper;
...
import com.browser.codedady.databases.DbAdapter_Bookmarks;
...
public class helper_main {
    ...
    public static void setTheme (Activity activity) {
        ...
        sharedPref = PreferenceManager.getDefaultSharedPreferences(activity);
        String theme = sharedPref.getString("theme", "1");
    ...
    public static void onStart (final Activity activity) {
        ...
        //sharedPref.edit().putString("openURL", sharedPref.getString("startURL", "file:///android_asset/home.html")).apply();
        ...
        boolean show = sharedPref.getBoolean("introShowDo_notShow", false);
                            ...
                            .setAction(activity.getString(R.string.toast_yes), new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    try {
                                        ...
                                        runtime.exec("pm clear com.browser.codedady");
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                    }
                                }
    ...
    public static void installShortcut (Activity activity, String title, String url, View view) {
        ...
        i.setClassName(activity, "com.browser.codedady.Activity_Main");
